...
class CustomRenders {
  ...
  public static parseExprToHtml(expr: any, card_num?: number, action_mode: boolean = false, effect_mode: boolean = false): string {
    ...
    if (action_mode == true || effect_mode == true) {
      ...
      rethtm += "</div></div>";
      if (action_mode == true) rethtm += '<div class="action_arrow"></div>';
      else rethtm += '<div class="effect_separator">:</div>';
  ...
  private static customcard_rules_37() {
    return (
      '<div class="card_icono icono_prod">' +
  ...
  private static customcard_action_69() {
    return (
      '<div class="card_action_line card_action_icono"><div class="card_icono icono_losses cnt_losses"><div class="outer_gains">' +
  ...
  static customcard_action_71() {
    return (
      '<div class="card_action_line card_action_icono"><div class="card_icono">' +
      '<div class="outer_gains">' +
  ...
  private static customcard_vp_85() {
    return (
      '<div class="vp_qty">1/</div><div class="outer_redborder redborder_hex"><div class="cnt_media tracker tracker_city depth_2"></div></div>' +
  ...
  private static customcard_rules_102() {
    return (
      '<div class="groupline"><div class="card_icono icono_prod"><div class="outer_production"><div class="production_line cnt_gains"><div class="outer_production">' +
  ...
  private static customcard_action_110() {
    return (
      '<div class="action_arrow"></div><div class="outer_gains">' +
      _("ACTION : LOOK AT THE TOP CARD AND EITHER BUY IT OR DISCARD IT") +
      "</div>"
    );
  }
  ...
  private static customcard_rules_121() {
    return (
      '<div class="card_icono icono_losses cnt_losses"><div class="outer_gains"><div class="plusminus">-</div>3<div class="outer_redborder redborder_resource">' +
      this.parseSingleItemToHTML(this.getParse("u", 0), 1) +
  ...
  private static customcard_rules_124() {
    return (
      '<div class="card_icono icono_losses cnt_losses"><div class="outer_gains">' +
      _("STEAL") +
      '&nbsp;2&nbsp;<div class="outer_redborder redborder_resource">' +
      this.parseSingleItemToHTML(this.getParse("s", 0), 1) +
  ...
  private static customcard_rules_152() {
    return (
      '<div class="card_icono icono_prod"><div class="outer_production"><div class="production_line cnt_losses"><div class="plusminus">-</div>X&nbsp;<div class="outer_production">' +
  ...
  private static customcard_rules_163() {
    return (
      '<div class="card_icono icono_gains cnt_gains"><div class="outer_gains"><div class="groupline">' +
      this.parseSingleItemToHTML(this.getParse("tr", 0), 1) +
      "&nbsp;&nbsp;" +
  ...
  private static customcard_rules_200() {
    return (
      '<div class="card_icono icono_prod"><div class="outer_production"><div class="production_line cnt_losses"><div class="plusminus">-</div><div class="outer_production"><div class="cnt_media token_img tracker_e depth_1"></div></div></div><div class="production_line cnt_gains"><div class="plusminus">-</div>' +
  ...
  private static customcard_rules_207() {
    return (
      '<div class="card_icono icono_prod"><div class="outer_production"><div class="production_line cnt_gains"><div class="outer_production"><div class="cnt_media token_img tracker_m depth_1">1</div></div>&nbsp;/&nbsp;<div class="outer_production">2' +
  ...
  public static customcard_effect_P39(action) {
    return (
      '<div class="card_action_line card_action_icono">' +
      action +
