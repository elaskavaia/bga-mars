...
declare class GameGui {
  ...
  ajaxcall(url: string, args: object, bind: GameGui, resultHandler: (result: any) => void, allHandler?: (err: any, message?: any) => void): void;
  bgaPerformAction(action: string, args?: object, options?: object): Promise<void>;
